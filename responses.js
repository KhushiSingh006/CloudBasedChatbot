function getBotResponse(input) {
    ...
    else if (input == "are you part of the Matrix?")
    {
        ...
        return "I am Khushi's Bot";
    }
    else if (input== "are you a human?")
    {
        return "No, I am a bot, ChatBot";
    }
    else {
        return "Try asking something else!<br><br>You can enter a student's credentials to get<br>information about students :)";
    }
}